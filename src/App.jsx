        ...
        <Provider store={store}>
          <ThemeProvider>
            ...
            <Routes>
              ...
              <Route path="/template1" element={<UserTemplate01 />} />
              ...
              <Route path="/dashboard" element={<ProtectedRoute><Dashboard /></ProtectedRoute>}>
                ...
                <Route path="edit-social-account" element={<EditSocialAccount />} />
              ...
              <Route path="/" element={<Layout />}>
                ...
                <Route path="designer-category" element={<Designer />} />
                <Route path="freelancer-category" element={<Freelancer />} />
              </Route>

              {/* --- Auth Routes --- */}
              <Route path="/login" element={<Login />} />
              <Route path="/register" element={<Register />} />
              <Route path="/form" element={<FormEducation />} />

              {/* --- Dynamic Username / Public Portfolio --- */}
