        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4  relative z-10">
          <div className="flex max-lg:flex-col justify-between gap-8 items-center">
            ...
            <div className="lg:col-span-7 order-2 lg:order-1">
              ...
              <h1
                className="fraunces font-black leading-[0.88] mb-6"
                style={{ fontSize: "clamp(4rem,11vw,9rem)", color: "#1C1C1C" }}
              >
                KAI
                <br />
                <span className="squiggle">TANAKA</span>
              </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="zine-card rounded-2xl overflow-hidden bg-white">
              {[
                ...
                {
                  no: "04",
                  company: "Coffee Shop Side Hustle",
                  role: "Menu & Brand Designer",
                  period: "2021–2022",
                },
                ...
                <div
                  ...
                  style={{ borderBottom: i < 3 ? "2px solid #F0F0EA" : "none" }}
                >
                  <span
                    className="fraunces font-black text-4xl min-w-[3rem] leading-none"
                    style={{
                      color: hoveredJob === i ? "var(--orange)" : "#E8E8E0",
                    }}
                  >
                    {no}
                  </span>
                  <div className="flex-1 min-w-0">
                    <h4 className="font-black text-base truncate">{company}</h4>
                    <p
                      className="text-xs font-medium"
                      style={{
                        color: hoveredJob === i ? "var(--orange)" : "#888",
                      }}
                    >
                      {role}
                    </p>
                  ...
                  <span
                    className="shrink-0 text-xs font-medium rounded-full px-3 py-1 hidden sm:block"
                    style={{
                      background: hoveredJob === i ? "var(--lime)" : "#F0F0EA",
