...
export default function PortfolioGirl() {
  ...
  const handleEditClick = (templateId) => {
    ...
    navigate(`/dashboard/portfolio/2`);
  };
  useEffect(() => {
  ...
  return (
    <div className="bg-rose-50 my-18 text-stone-800 min-h-screen overflow-x-hidden">
      <style>{`
]
        ...
        <div className="container mx-auto md:max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <button
              ...
              className=" text-3xl font-bold italic text-stone-800 tracking-wide"
            >
            ...
            <button
              ...
              className="lg:hidden w-10 h-10 border-chic flex flex-col items-center justify-center gap-1.5 bg-white"
            >
              <span
        ...
        <div className="container mx-auto md:max-w-7xl px-4 sm:px-6 lg:px-8  py-6">
          <div className="grid lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="lg:col-span-7 order-2 lg:order-1">
              ...
              <p className=" text-xl font-light italic text-rose-400 tracking-widest mb-3">
                Hello, I'm
              </p>
              <h1
                className=" font-bold leading-none text-stone-900 mb-2"
                style={{ fontSize: "clamp(4.5rem,11vw,8.5rem)" }}
              >
                Léa
              </h1>
              <h1
                className=" font-bold leading-none text-rose-400 mb-4"
                style={{ fontSize: "clamp(4.5rem,11vw,8.5rem)" }}
              >
                Moreau
              </h1>
            ...
            {/* Image — 5 cols */}
            <div className="lg:col-span-5 lg:my-0 sm:mb-15 sm:justify-center sm:items-start order-1 lg:order-2 flex justify-center lg:justify-end">
              <div className="relative lg:mx-0 mx-4 lg:my-0 my-15 mt-8">
                {/* Frame */}
                ...
                <img
                  ...
                  alt="Profile"
                  className="relative w-full lg:mx-0 sm sm:w-full lg:w-80 xl:w-115 aspect-[3/4] object-cover border-chic"
                />
                {/* Badge */}
      ...
      {/* ── EXPERIENCE ── */}
      <section id="experience" className="py-10 bg-rose-50 stripe-bg">
        <div className="container mx-auto md:max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-16 border-b-2 border-stone-800 pb-6">
            ...
            <span
              className=" font-light text-stone-200 leading-none select-none hidden lg:block"
              style={{ fontSize: "8rem" }}
            >
              03
            </span>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                <h4 className=" font-bold text-2xl text-stone-900 leading-tight mb-1">
                  {title}
                </h4>
      ...
      <section
        id="job"
        className="py-10 bg-rose-200 border-y-2 border-stone-800"
      >
        <div className="container mx-auto md:max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {[
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h4 className=" font-bold text-2xl sm:text-3xl leading-none truncate">
                    {company}
                  </h4>
                  <p
                ...
                {/* <span
                  className={` italic text-3xl shrink-0 ${hoveredJob === i ? "text-rose-300" : "text-rose-200"}`}
                >
                  →
                </span> */}
              </div>
      ...
      {/* ── SCHOOL ── */}
      <section id="school" className="py-10 bg-rose-50">
        <div className="container mx-auto md:max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-16 border-b-2 border-stone-800 pb-6">
            <div>
              <span className="text-xs tracking-[0.25em] uppercase text-rose-400 font-medium block mb-3">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {[
              ...
              >
                ...
                <div>
                  <h4 className=" font-bold text-xl text-stone-900 leading-tight mb-1">
                    {degree}
                  </h4>
                  <p className="text-rose-400 text-xs font-medium uppercase tracking-[0.15em] mb-1">
                    {school}
      ...
      {/* ── SKILL ── */}
      <section id="skill" className="py-10 bg-stone-800 text-white">
        <div className="container mx-auto md:max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div key={name} className="group">
                  <div className="flex justify-between items-center mb-3">
                    <div className="flex items-center gap-3">
                      <span className=" font-semibold text-xl text-white group-hover:text-rose-300 transition-colors">
                        {name}
                      </span>
      ...
      {/* ── CONTACT ── */}
      <section id="contact" className="py-10 bg-rose-50 dot-bg">
        <div className="container mx-auto md:max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <h2
                className=" font-bold leading-none text-stone-900 mb-8"
      ...
      <footer className="bg-stone-800 border-t-2 border-stone-700 py-8">
        <div className="container mx-auto md:max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <span className=" text-2xl font-bold italic text-rose-300">
            Léa<span className="text-rose-400 not-italic">✿</span>
          </span>
